<a href="https://app.daily.dev/beesou777"><img src="https://api.daily.dev/devcards/v2/l8ZBl2fPJHAiouPYsur5S.png?type=wide&r=j0n" width="992" alt="bishwa shah's Dev Card"/></a>
```javascript
class Bio {
  constructor() {
    this.aboutMe = {
